...
require_relative 'collie_lsp/position'
...
require_relative 'collie_lsp/lrama_diagnostics'
require_relative 'collie_lsp/symbol_index'
require_relative 'collie_lsp/workspace_index'
...
require_relative 'collie_lsp/handlers/support'
